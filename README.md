...
This project does not use any form of AI for its development or testing process; neither does the project accept code that is (partially or wholly) generated by AI, even if it is fully disclosed.

***#MadeWithoutAI #NoAISlop***
